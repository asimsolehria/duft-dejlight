    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="order-text-div">
                <h2>order processing (Order <?php echo "#" . $order->get_order_number(); ?>)</h2>
            </div>
        </div>
        <div class="sub-container">
            <div>
                ...
                <p>
                    Så er din bestilling pakket og fragtbilen er på vej.
                    Din pakke skulle gerne blive leveret eller være klar til afhentning indenfor de næste 2 - 4 hverdage.
                    Følg din leverance via trackingkode herunder.
                </p>
                <p></p>
                <p>
                    De bedste hilsener
