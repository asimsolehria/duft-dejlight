...
if ( $sitepress ) {
	...
	$new_lan = get_post_meta( $order->get_id(), 'wpml_language', true );
...
$display_tracking_info_at = $ast->get_option_value_from_array( 'tracking_info_settings', 'display_tracking_info_at', $ast_customizer->defaults['display_tracking_info_at'] );
...
if ( ( !$tpi_order ) && ( $show_tracking_info ) ) {
